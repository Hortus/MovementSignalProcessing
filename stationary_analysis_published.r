...
lmHz0.9 <- lm(Hz0.9 ~ VideoDate + Line + PlantingDate + Line/Rep + Line*PlantingDate + (Line/Rep)*PlantingDate, data = finaldf)
summary(aov(lmHz0.9)) # no significant line*position interaction
summary(lmHz0.9)
lmHz1.1 <- lm(Hz1.1 ~ VideoDate + Line + PlantingDate + Line/Rep + Line*PlantingDate + (Line/Rep)*PlantingDate, data = finaldf)
summary(aov(lmHz1.1)) # no significant line*position interaction
summary(lmHz1.1)
lmHz1.3 <- lm(Hz1.3 ~ VideoDate + Line + PlantingDate + Line/Rep + Line*PlantingDate + (Line/Rep)*PlantingDate, data = finaldf)
summary(aov(lmHz1.3)) # no significant line*position interaction
summary(lmHz1.3)
lmHz1.5 <- lm(Hz1.5 ~ VideoDate + Line + PlantingDate + Line/Rep + Line*PlantingDate + (Line/Rep)*PlantingDate, data = finaldf)
summary(aov(lmHz1.5)) # no significant line*position interaction
summary(lmHz1.5)
lmHz1.7 <- lm(Hz1.7 ~ VideoDate + Line + PlantingDate + Line/Rep + Line*PlantingDate + (Line/Rep)*PlantingDate, data = finaldf)
